...
// In the start, all registers are set to 0, this will put the initial values
action start_windows() {
    register_write(valid_instance_register, 0, 0x0005);
    register_write(future_instance_register, 0, 0x0008);
}
